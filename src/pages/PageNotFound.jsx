  ...
  return (
    <>
      <div className="flex items-center justify-center text-center h-full">
        <div className="w-auto mt-30 md:p-20 p-5">
          <h1 className="text-6xl text-gray-900 font-extrabold">Oops!</h1>
          <p className="text-3xl text-gray-900 font-extrabold mt-2">
            PAGE NOT FOUND
          </p>
          <p className="mt-5 text-gray-900 text-2xl">
            It seems the page you requested is unavailable or may have been
            moved.
          </p>
          <p className="text-gray-900 text-lg mt-5">
            {" "}
            Kindly retun to the homepage or use the navigation above
          </p>
          <Link to="/">
            <button
              type="button"
