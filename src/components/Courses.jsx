import React from "react";
 ...
 const courses = [
   ...
   },
   {
     ...
     duration: "48h",
     image: "/ReactandFrontendDevelopment.avif",
   },
   {
     id: 7,
...
export default function Courses() {
   ...
   return (
     <>
       <div className={`p-6 mt-15 py-10min-h-screen`}>
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
           {courses.map((course) => (
             <div
               key={course.id}
               className="bg-gray-900 p-4 rounded-xl w-full shadow-lg "
             >
               ...
               <div className="mt-4">
                 ...
                 <div className="flex items-center justify-between mt-4">
                   ...
                   <button className="p-2 rounded-2xl bg-teal-600 outline-none cursor-pointer text-gray-300">
                     Enroll Now
                   </button>
                 </div>
               </div>
