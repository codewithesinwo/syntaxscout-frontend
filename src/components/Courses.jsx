                ...
                <div className="md:w-3/5 p-8 md:p-12 overflow-y-auto">
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-6 pt-8 border-t border-white/10">
                      ...
                      <button className="cursor-pointer flex-grow md:flex-grow-0 flex items-center justify-center gap-3 bg-indigo-600 hover:bg-indigo-500 text-white px-10 py-4 rounded-2xl font-bold text-lg transition-all shadow-xl shadow-indigo-600/20 active:scale-95">
